      ...
      sidebarPanel(
        ...
        selectInput(
          ...
          choices = list(
            ...
            "Daño a Órganos y Comorbilidades" = c(
              "Daño Renal" = "Danio_renal",
              "Daño Neuropsiquiátrico" = "Danio_neuropsiquiatrico",
              "Daño Pulmonar" = "Danio_pulmonar",
              "Daño Cardiovascular" = "Danio_cardiovascular",
  ...
  analisis_comparativa <- reactive({
    ...
    if (es_categorica_v2) {
      ...
      p_grafico <- ggplot(
        ...
        # --- CAMBIO AQUÍ: Usamos la función traductora ---
        labs(
          y = "Frecuencia",
      ...
      texto_html <- paste0(
        ...
        "<p><b>Interpretación:</b> Tras simular múltiples escenarios aleatorios, la prueba indica que <b>", significativo, "</b> diferencias estadísticamente significativas entre los promedios de los grupos evaluados. ",
      ...
      p_grafico <- ggplot(
        df_clean, 
        aes(
          x = !!sym(input$comp_var2), 
          fill = factor(!!sym(input$comp_var1))
        )
      ) +
